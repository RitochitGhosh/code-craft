  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="w-56 group relative flex justify-between items-center gap-2 px-4 py-2.5 bg-[#1e1e2e]/80 hover:bg-[#262637] text-md rounded-lg transition-all duration-200 border border-gray-800/50 hover:border-gray-700"
      >
